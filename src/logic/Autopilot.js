...
import { BEAUTIFUL_INTERVALS } from '../config.js';
...
export class Autopilot {
     ...
     * @param {import('../core/PerformerState').PerformerState[]} performers - Array of all performer states.
     * @param {number[]} indices - Indices of the performers to control.
     * @param {Object} config - The application configuration object.
     */
    constructor(performers, indices, config) {
     ...
     * @private
     * @param {import('../core/PerformerState').PerformerState} state - The performer state to modify.
     */
    _turnOn(state) {
        state.hasPerformer = true;
        state.target.bpmPref = THREE.MathUtils.randFloat(this.config.audio.bpmMin, this.config.audio.bpmMax);
