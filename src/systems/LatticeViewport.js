...
export class LatticeViewport {
    ...
    constructor(colorHex, config) {
        ...
        this.uniforms = {
            uTime: { value: 0 },
            uPhaseZ: { value: 0 },
            uGridSize: { value: this.config.grid.size },
     ...
     * @param {import('../core/PerformerState').PerformerState} performerState - The state of the performer to render.
     */
